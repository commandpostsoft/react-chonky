...
export declare const isPromise: <T>(value: MaybePromise<T> | any) => value is Promise<T>;
export declare const defineFileAction: <Action extends FileAction>(action: Action, effect?: FileActionEffect<FileAction>) => WritableProps<Action>;
/**
...
export declare const getValueOrFallback: <T extends unknown>(value: T | undefined, fallback: T, desiredType?: 'boolean' | 'string' | 'number') => NonNullable<T>;
