...
var ExactTrie = require('exact-trie');
...
var getSortedFileIds = /*#__PURE__*/toolkit.createSelector([getFileIds, getSortOrder, /*#__PURE__*/makeGetFiles(getFileIds), /*#__PURE__*/makeGetAction(getSortActionId), /*#__PURE__*/makeGetOptionValue(OptionIds.ShowFoldersFirst, false)], function (fileIds, sortOrder, files, sortAction, showFolderFirst) {
  ...
  var sortedFileIds = fastSort.sort([].concat(files)).by(sortFunctions).map(function (file) {
...
var getDisplayFileIds = /*#__PURE__*/toolkit.createSelector([getSortedFileIds, getHiddenFileIdMap], /** Returns files that will actually be shown to the user. */
function (sortedFileIds, hiddenFileIdMap) {
  return sortedFileIds.filter(function (id) {
    return !id || !hiddenFileIdMap[id];
  });
});
var getLastClickIndex = /*#__PURE__*/toolkit.createSelector([_getLastClick, getSortedFileIds], /** Returns the last click index after ensuring it is actually still valid. */
...
var thunkUpdateToolbarNContextMenuItems = function thunkUpdateToolbarNContextMenuItems(fileActions) {
  return function (dispatch) {
    ...
    var groupIcons = {
      Actions: exports.ChonkyIconName.dropdown,
      Options: exports.ChonkyIconName.config
    };
    var groupSortOrder = {
      Options: 0,
      Actions: 1
...
var EssentialActions = {
  ...
  OpenParentFolder: /*#__PURE__*/defineFileAction({
    ...
    var reduxState = getReduxState();
    var parentFolder = selectParentFolder(reduxState);
...
var DefaultActions = {
  ...
  ClearSelection: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: exports.ChonkyIconName.clearSelection
    },
  ...
  EnableListView: /*#__PURE__*/defineFileAction({
    id: 'enable_list_view',
    fileViewConfig: {
      mode: exports.FileViewMode.List,
      entryHeight: 30
    },
    button: {
      name: 'Switch to List',
      toolbar: true,
      icon: exports.ChonkyIconName.list,
      // iconOnly: true,
      group: 'Options'
    }
  }),
  ...
  EnableCompactView: /*#__PURE__*/defineFileAction({
    ...
    fileViewConfig: {
      mode: exports.FileViewMode.Compact,
      entryHeight: 40,
      entryWidth: 220
    },
    button: {
      ...
      toolbar: true,
      icon: exports.ChonkyIconName.compact,
      // iconOnly: true,
      group: 'Options'
    }
  }),
  ...
  EnableGridView: /*#__PURE__*/defineFileAction({
    id: 'enable_grid_view',
    fileViewConfig: {
      mode: exports.FileViewMode.Grid,
      entryWidth: 100,
      entryHeight: 100
    },
    button: {
      name: 'Switch to Grid',
      toolbar: true,
      icon: exports.ChonkyIconName.smallThumbnail,
      // iconOnly: true,
      group: 'Options'
    }
  }),
...
var ExtraActions = {
  ...
  CopyFiles: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: exports.ChonkyIconName.copy
    }
  }),
  /**
  ...
  CreateFolder: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      icon: exports.ChonkyIconName.folderCreate
    }
  }),
  /**
  ...
  UploadFiles: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      icon: exports.ChonkyIconName.upload
    }
  }),
  /**
  ...
  DownloadFiles: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: exports.ChonkyIconName.download
    }
  }),
  /**
  ...
  DeleteFiles: /*#__PURE__*/defineFileAction({
    ...
    button: {
      ...
      contextMenu: true,
      group: 'Actions',
      icon: exports.ChonkyIconName.trash
    }
  })
};
...
var reducers = {
  ...
  setForceEnableOpenParent: function setForceEnableOpenParent(state, action) {
    state.forceEnableOpenParent = action.payload;
  },
  setHideToolbarInfo: function setHideToolbarInfo(state, action) {
...
var _createSlice = /*#__PURE__*/toolkit.createSlice({
    name: 'root',
...
var useStoreWatchers = function useStoreWatchers(store) {
  React.useEffect(function () {
    ...
    return function () {
      for (var _i = 0, _unsubscribeCallbacks = unsubscribeCallbacks; _i < _unsubscribeCallbacks.length; _i++) {
        var unsubscribe = _unsubscribeCallbacks[_i];
        unsubscribe();
      }
    };
  }, [store]);
...
var useParamSelector = function useParamSelector(parametrizedSelector) {
  ...
  var selector = React.useCallback(function (state) {
...
})(exports.I18nNamespace || (exports.I18nNamespace = {}));
...
var getActionI18nId = function getActionI18nId(actionId, stringId) {
  return "chonky." + exports.I18nNamespace.FileActions + "." + actionId + "." + stringId;
};
var useLocalizedFileActionGroup = function useLocalizedFileActionGroup(groupName) {
  var intl = reactIntl.useIntl();
  return React.useMemo(function () {
    return intl.formatMessage({
      id: getI18nId(exports.I18nNamespace.FileActionGroups, groupName),
...
var useLocalizedFileEntryStrings = function useLocalizedFileEntryStrings(file) {
  var intl = reactIntl.useIntl();
  var formatters = React.useContext(ChonkyFormattersContext);
  return React.useMemo(function () {
    return {
...
var defaultFormatters = {
  ...
  formatFileSize: function formatFileSize(_intl, file) {
    ...
    var size = file.size;
    var sizeData = filesize.filesize(size, {
      bits: false,
      output: 'object'
    });
...
var ChonkyFormattersContext = /*#__PURE__*/React.createContext(defaultFormatters);
 ...
 * @license MIT
 */
var ChonkyIconContext = /*#__PURE__*/React.createContext(ChonkyIconPlaceholder);
...
var getIconTrie = function getIconTrie() {
  ...
  // Generic file types
  [exports.ChonkyIconName.license, ['license']], [exports.ChonkyIconName.config, ['sfk', 'ini', 'yml', 'toml', 'iml']], [exports.ChonkyIconName.model, ['3ds', 'obj', 'ply', 'fbx']], [exports.ChonkyIconName.database, ['csv', 'json', 'sql', 'sqlite', 'sqlite3', 'npy', 'npz', 'rec', 'idx', 'hdf5']], [exports.ChonkyIconName.text, ['txt', 'md', 'mdx']], [exports.ChonkyIconName.archive, ['zip', 'rar', 'tar', 'tar.gz', '7z']], [exports.ChonkyIconName.image, ImageExtensions], [exports.ChonkyIconName.video, VideoExtensions], [exports.ChonkyIconName.code, ['html', 'php', 'css', 'sass', 'scss', 'less', 'cpp', 'h', 'hpp', 'c', 'xml']], [exports.ChonkyIconName.info, ['bib', 'readme', 'nfo']], [exports.ChonkyIconName.key, ['pem', 'pub']], [exports.ChonkyIconName.lock, ['lock', 'lock.json', 'shrinkwrap.json']], [exports.ChonkyIconName.music, AudioExtensions], [exports.ChonkyIconName.terminal, ['run', 'sh']], [exports.ChonkyIconName.trash, ['.Trashes']], [exports.ChonkyIconName.users, ['authors', 'contributors']],
  // OS file types
  [exports.ChonkyIconName.linux, ['AppImage']], [exports.ChonkyIconName.ubuntu, ['deb']], [exports.ChonkyIconName.windows, ['exe']],
  // Programming language file types
  [exports.ChonkyIconName.rust, ['rs', 'rlib']], [exports.ChonkyIconName.python, ['py', 'ipynb']], [exports.ChonkyIconName.nodejs, ['js', 'jsx', 'ts', 'tsx', 'd.ts']], [exports.ChonkyIconName.php, ['php']],
  // Development tools file types
  [exports.ChonkyIconName.git, ['.gitignore']],
  // Other program file types
  [exports.ChonkyIconName.pdf, ['pdf']], [exports.ChonkyIconName.excel, ['xls', 'xlsx']], [exports.ChonkyIconName.word, ['doc', 'docx', 'odt']], [exports.ChonkyIconName.flash, ['swf']]];
...
var useIconData = function useIconData(file) {
  return React.useMemo(function () {
    if (!file) return {
      icon: exports.ChonkyIconName.loading,
      colorCode: 0
    };
    if (file.isDir === true) return {
      icon: exports.ChonkyIconName.folder,
      colorCode: 0
    };
    var match = iconTrie.getWithCheckpoints(file.name, '.', true);
    return match ? match : {
      icon: exports.ChonkyIconName.file,
      colorCode: 32
    };
  }, [file]);
};
...
var makeLocalChonkyStyles = function makeLocalChonkyStyles(styles) {
  return reactJss.createUseStyles(styles);
};
var makeGlobalChonkyStyles = function makeGlobalChonkyStyles(makeStyles) {
  ...
  // @ts-ignore
  var useStyles = reactJss.createUseStyles(makeGlobalStyles);
  return function () {
        ...
        return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", Promise.resolve(dispatch(thunkRequestFileAction(action, payload))));
              case 1:
              case "end":
...
var ChonkyBusinessLogicInner = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  useDTE(reduxActions.setForceEnableOpenParent, getValueOrFallback(props.forceEnableOpenParent, defaultConfig.forceEnableOpenParent, 'boolean'));
  useDTE(reduxActions.setHideToolbarInfo, getValueOrFallback(props.hideToolbarInfo, defaultConfig.hideToolbarInfo, 'boolean'));
...
var useDndContextAvailable = function useDndContextAvailable() {
  var dndContext = React.useContext(reactDnd.DndContext);
...
var useDragIfAvailable = function useDragIfAvailable() {
  ...
  var mockHook = React.useCallback(function () {
    return [{}, function () {
      return null;
    }, function () {
      return null;
  ...
  // @ts-ignore
  var useHook = dndContextAvailable ? reactDnd.useDrag : mockHook;
...
var useDropIfAvailable = function useDropIfAvailable() {
  ...
  // @ts-ignore
  var useHook = dndContextAvailable ? reactDnd.useDrop : mockHook;
  return useHook.apply(void 0, arguments);
};
...
var useContextMenuTrigger = function useContextMenuTrigger() {
  var dispatch = reactRedux.useDispatch();
  var contextMenuMountedRef = useInstanceVariable(reactRedux.useSelector(selectContextMenuMounted));
...
var useStyles$m = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    fileDragPreview: {
...
var ChonkyPresentationLayer = function ChonkyPresentationLayer(_ref) {
  ...
  var dispatch = reactRedux.useDispatch();
  var fileActionIds = reactRedux.useSelector(selectFileActionIds);
  var dndDisabled = reactRedux.useSelector(selectIsDnDDisabled);
  var clearSelectionOnOutsideClick = reactRedux.useSelector(selectClearSelectionOnOutsideClick);
  ...
  var hotkeyListenerComponents = React.useMemo(function () {
...
var useStyles$l = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    chonkyRoot: {
...
var FileBrowser = /*#__PURE__*/React.forwardRef(function (props, ref) {
  ...
  var formatters = React.useMemo(function () {
  ...
  var theme = React.useMemo(function () {
    ...
    var muiTheme = styles.createTheme(muiOptions);
    var combinedTheme = merge(muiTheme, merge(merge(lightTheme, darkMode ? darkThemeOverride : {}), props.theme || {}));
    return isMobileBreakpoint ? merge(combinedTheme, mobileThemeOverride) : combinedTheme;
  }, [darkMode, isMobileBreakpoint]);
  var chonkyComps = React.createElement(React.Fragment, null, React.createElement(ChonkyBusinessLogic, _extends({
    ref: ref
  }, props)), React.createElement(ChonkyPresentationLayer, null, children));
  return React.createElement(reactIntl.IntlProvider, _extends({
    locale: "en",
    defaultLocale: "en"
    ...
    store: store
  }, React.createElement(reactJss.ThemeProvider, {
    theme: theme
  }, React.createElement(styles.StyledEngineProvider, {
    injectFirst: true
  ...
  }, disableDragAndDrop || disableDragAndDropProvider ? chonkyComps : React.createElement(reactDnd.DndProvider, {
...
var useFolderChainItems = function useFolderChainItems() {
  var folderChain = reactRedux.useSelector(selectFolderChain);
  var dispatch = reactRedux.useDispatch();
  var folderChainItems = React.useMemo(function () {
    var items = [];
...
var useFileDrag = function useFileDrag(file) {
  ...
  var getDndStartPayload = React.useCallback(function () {
  ...
  // For drag source
  var dispatch = reactRedux.useDispatch();
  var canDrag = React.useCallback(function () {
  ...
  var onDragEnd = React.useCallback(function (item, monitor) {
  ...
  var collect = React.useCallback(function (monitor) {
    return {
      isDragging: monitor.isDragging()
    };
  }, []);
...
var useFileDrop = function useFileDrop(_ref) {
  ...
  var folderChainRef = useInstanceVariable(reactRedux.useSelector(selectFolderChain));
  var onDrop = React.useCallback(function (_item, monitor) {
  ...
  var canDrop = React.useCallback(function (item, monitor) {
    ...
    var _item$payload = item.payload,
      ...
      selectedFiles = _item$payload.selectedFiles;
...
var useFileEntryDnD = function useFileEntryDnD(file) {
  ...
  var dndState = React.useMemo(function () {
    return {
      dndIsDragging: dndIsDragging,
      dndIsOver: dndIsOver,
      dndCanDrop: dndCanDrop
...
var useDndHoverOpen = function useDndHoverOpen(file, dndState) {
  var dispatch = reactRedux.useDispatch();
  var currentFolderRef = useInstanceVariable(reactRedux.useSelector(selectCurrentFolder));
  React.useEffect(function () {
...
var useStyles$k = /*#__PURE__*/makeLocalChonkyStyles(function () {
  return {
...
var useFileEntryState = function useFileEntryState(file, selected, focused) {
  ...
  return React.useMemo(function () {
    ...
    var icon = thumbnailLoading ? exports.ChonkyIconName.loading : iconData.icon;
    return {
...
var useDndIcon = function useDndIcon(dndState) {
  ...
  if (dndState.dndIsOver) {
    ...
    dndIconName = showDropIcon ? exports.ChonkyIconName.dndCanDrop : exports.ChonkyIconName.dndCannotDrop;
  } else if (dndState.dndIsDragging) {
    dndIconName = exports.ChonkyIconName.dndDragging;
  }
  return dndIconName;
};
var useModifierIconComponents = function useModifierIconComponents(file) {
  var modifierIcons = React.useMemo(function () {
    var modifierIcons = [];
    if (FileHelper.isHidden(file)) modifierIcons.push(exports.ChonkyIconName.hidden);
    if (FileHelper.isSymlink(file)) modifierIcons.push(exports.ChonkyIconName.symlink);
    if (FileHelper.isEncrypted(file)) modifierIcons.push(exports.ChonkyIconName.lock);
    return modifierIcons;
  }, [file]);
  var ChonkyIcon = React.useContext(ChonkyIconContext);
  var modifierIconComponents = React.useMemo(function () {
...
var useThumbnailUrl = function useThumbnailUrl(file) {
  var thumbnailGenerator = reactRedux.useSelector(selectThumbnailGenerator);
  ...
  var loadingAttempts = React.useRef(0);
  React.useEffect(function () {
...
var useFileClickHandlers = function useFileClickHandlers(file, displayIndex) {
  ...
  var onMouseClick = React.useCallback(function (event, clickType) {
    if (!file) return;
  ...
  var onKeyboardClick = React.useCallback(function (event) {
    if (!file) return;
  ...
  var onSingleClick = React.useCallback(function (event) {
    return onMouseClick(event, 'single');
  }, [onMouseClick]);
  var onDoubleClick = React.useCallback(function (event) {
...
exports.CustomVisibilityState = void 0;
...
})(exports.CustomVisibilityState || (exports.CustomVisibilityState = {}));
...
var useFileActionProps = function useFileActionProps(fileActionId) {
  var _action$option;
  var parentFolder = reactRedux.useSelector(selectParentFolder);
  var forceEnableOpenParent = reactRedux.useSelector(selectForceEnableOpenParent);
  var fileViewConfig = reactRedux.useSelector(selectFileViewConfig);
  var sortActionId = reactRedux.useSelector(selectSortActionId);
  var sortOrder = reactRedux.useSelector(selectSortOrder);
  var action = useParamSelector(selectFileActionData, fileActionId);
  // @ts-ignore
  var optionValue = useParamSelector(selectOptionValue, action == null || (_action$option = action.option) == null ? void 0 : _action$option.id);
  ...
  return React.useMemo(function () {
    ...
    if (action.sortKeySelector) {
      if (sortActionId === action.id) {
        if (sortOrder === SortOrder.ASC) {
          icon = exports.ChonkyIconName.sortAsc;
        } else {
          icon = exports.ChonkyIconName.sortDesc;
        }
      } else {
        icon = exports.ChonkyIconName.placeholder;
      }
    } else if (action.option) {
      if (optionValue) {
        icon = exports.ChonkyIconName.toggleOn;
      } else {
        icon = exports.ChonkyIconName.toggleOff;
      }
    }
    ...
    if (action.customVisibility !== undefined) {
      customDisabled = action.customVisibility() === exports.CustomVisibilityState.Disabled;
      customActive = action.customVisibility() === exports.CustomVisibilityState.Active;
    }
...
var ToolbarButton = /*#__PURE__*/React.memo(function (props) {
  ...
  var iconComponent = icon || iconOnly ? React.createElement("div", {
    ...
    icon: icon ? icon : exports.ChonkyIconName.fallbackIcon,
    fixedWidth: true
  })) : null;
  ...
  }, iconComponent, text && !iconOnly && React.createElement("span", null, text), dropdown && text && !iconOnly && React.createElement("div", {
    className: classes.iconDropdown
  }, React.createElement(ChonkyIcon, {
    icon: exports.ChonkyIconName.dropdown,
    fixedWidth: true
  })));
});
var useStyles$j = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    baseButton: {
...
var SmartToolbarButton = /*#__PURE__*/React.memo(function (props) {
  ...
  if (action.customVisibility !== undefined && action.customVisibility() === exports.CustomVisibilityState.Hidden) return null;
...
var FolderChainButton = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var ChonkyIcon = React.useContext(ChonkyIconContext);
  var classes = useStyles$i(dndState);
  ...
  var icon = first && (file == null ? void 0 : file.folderChainIcon) === undefined ? exports.ChonkyIconName.folder : file == null ? void 0 : file.folderChainIcon;
  return React.createElement("div", {
...
var useStyles$i = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    buttonContainer: {
      position: 'relative'
    },
...
var FileNavbar = /*#__PURE__*/React.memo(function () {
  ...
  var folderChainComponents = React.useMemo(function () {
    var components = [];
...
var useStyles$h = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    navbarWrapper: {
...
var useStyles$g = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    baseButton: {
...
var ToolbarDropdown = /*#__PURE__*/React.memo(function (props) {
  ...
  var menuItemComponents = React.useMemo(function () {
  ...
  return React.createElement(React.Fragment, null, React.createElement(ToolbarButton, _extends({}, toolbarButtonProps)), React.createElement(Menu, {
    autoFocus: true,
    keepMounted: true,
    elevation: 2,
    anchorEl: anchor,
...
var ToolbarInfo = /*#__PURE__*/React.memo(function () {
  ...
  var displayFileIds = reactRedux.useSelector(selectors.getDisplayFileIds);
  var selectionSize = reactRedux.useSelector(selectSelectionSize);
  var hiddenCount = reactRedux.useSelector(selectHiddenFileCount);
  var intl = reactIntl.useIntl();
  var fileCountString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.Toolbar, 'visibleFileCount'),
    defaultMessage: "{fileCount, plural,\n                =0 {# items}\n                one {# item}\n                other {# items}\n            }"
  }, {
    fileCount: displayFileIds.length
  });
  var selectedString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.Toolbar, 'selectedFileCount'),
    defaultMessage: "{fileCount, plural,\n                =0 {}\n                other {# selected}\n            }"
  }, {
    fileCount: selectionSize
  });
  var hiddenString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.Toolbar, 'hiddenFileCount'),
    defaultMessage: "{fileCount, plural,\n                =0 {}\n                other {# hidden}\n            }"
  }, {
...
var useStyles$e = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    infoContainer: {
      height: theme.toolbar.size,
      display: 'flex'
...
var ToolbarSearch = /*#__PURE__*/React.memo(function () {
  ...
  var searchPlaceholderString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.Toolbar, 'searchPlaceholder'),
  ...
  var dispatch = reactRedux.useDispatch();
  var reduxSearchString = reactRedux.useSelector(selectSearchString);
  var _useState = React.useState(reduxSearchString),
    localSearchString = _useState[0],
    setLocalSearchString = _useState[1];
  var _useDebounce = useDebounce(localSearchString, 50),
  ...
  return React.createElement(TextField, {
    ...
    InputProps: {
      ...
      startAdornment: React.createElement(InputAdornment, {
        ...
        icon: showLoadingIndicator ? exports.ChonkyIconName.loading : exports.ChonkyIconName.search,
...
var useStyles$d = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
...
var FileToolbar = /*#__PURE__*/React.memo(function (props) {
  var children = props.children;
  var classes = useStyles$c();
  var toolbarItems = reactRedux.useSelector(selectToolbarItems);
  var toolbarItemComponents = React.useMemo(function () {
    var components = [];
    for (var i = 0; i < toolbarItems.length; ++i) {
      ...
      var component = typeof item === 'string' ? React.createElement(SmartToolbarButton, {
        key: key,
        fileActionId: item
      }) : React.createElement(ToolbarDropdown, _extends({
        key: key
      }, item));
      components.push(component);
    }
  ...
  var hideToolbarInfo = reactRedux.useSelector(selectHideToolbarInfo);
  return React.createElement("div", {
  ...
  }, React.createElement(ToolbarSearch, null), !hideToolbarInfo && React.createElement(ToolbarInfo, null), children), React.createElement("div", {
    className: classes.toolbarRight
  }, toolbarItemComponents)));
});
var useStyles$c = /*#__PURE__*/makeGlobalChonkyStyles(function (theme) {
  return {
    toolbarWrapper: {},
    toolbarContainer: {
...
var FileListEmpty = function FileListEmpty(props) {
  ...
  var emptyString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.FileList, 'nothingToShow'),
  ...
  return React.createElement("div", {
    ...
    icon: exports.ChonkyIconName.folderOpen
  }), "\xA0 ", emptyString));
};
...
var useClickHandler = function useClickHandler(onSingleClick, onDoubleClick) {
  var doubleClickDelay = reactRedux.useSelector(selectDoubleClickDelay);
  var counter = React.useRef({
    clickCount: 0,
    clickTimeout: null
  });
  return React.useCallback(function (event) {
...
var ClickableWrapper = function ClickableWrapper(props) {
  ...
  var compProps = {
    onFocus: React.useCallback(function () {
  ...
  return React.createElement(WrapperTag, _extends({}, mergedProps), children);
};
...
var useStyles$a = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    modifierIcons: {
      color: theme.palette.text.primary,
      position: 'relative',
...
function (_ref) {
  ...
  var classes = useStyles$9(entryState);
  var ChonkyIcon = React.useContext(ChonkyIconContext);
...
var useStyles$9 = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    listFileEntry: {
...
var useStyles$8 = /*#__PURE__*/makeLocalChonkyStyles(function () {
  return {
    fillParent: {
      height: '100%'
    }
...
var GridEntryDndIndicator = /*#__PURE__*/React.memo(function (props) {
  ...
  var dndIconName = useDndIcon(dndState);
  var classes = useStyles$6(dndState);
  var ChonkyIcon = React.useContext(ChonkyIconContext);
...
var useStyles$6 = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    dndIndicator: {
      color: function color(dndState) {
...
var ListEntry = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var _useLocalizedFileEntr = useLocalizedFileEntryStrings(file),
    fileModDateString = _useLocalizedFileEntr.fileModDateString,
    fileSizeString = _useLocalizedFileEntr.fileSizeString;
  var styleState = React.useMemo(function () {
    return {
      entryState: entryState,
      dndState: dndState
    };
  }, [dndState, entryState]);
  var classes = useStyles$5(styleState);
  var commonClasses = useCommonEntryStyles(entryState);
  var ChonkyIcon = React.useContext(ChonkyIconContext);
  var fileEntryHtmlProps = useFileEntryHtmlProps(file);
  return React.createElement("div", _extends({
...
var useStyles$5 = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    listFileEntry: {
...
var SmartFileEntry = /*#__PURE__*/React.memo(function (_ref) {
  ...
  var EntryComponent;
  if (fileViewMode === exports.FileViewMode.List) EntryComponent = ListEntry;else if (fileViewMode === exports.FileViewMode.Compact) EntryComponent = CompactEntry;else EntryComponent = GridEntry;
  return dndDisabled ? React.createElement(ClickableWrapper, _extends({}, clickableWrapperProps), React.createElement(EntryComponent, _extends({}, fileEntryProps, {
    dndState: disabledDndState
  }))) : React.createElement(DnDFileEntry, {
    file: file
  }, function (dndState) {
    return React.createElement(ClickableWrapper, _extends({}, clickableWrapperProps), React.createElement(EntryComponent, _extends({}, fileEntryProps, {
      dndState: dndState
    })));
  });
});
SmartFileEntry.displayName = 'SmartFileEntry';
var useStyles$4 = /*#__PURE__*/makeGlobalChonkyStyles(function () {
  return {
...
var GridContainer = /*#__PURE__*/React.memo(function (props) {
  var width = props.width,
    height = props.height;
  var viewConfig = reactRedux.useSelector(selectFileViewConfig);
  var displayFileIds = reactRedux.useSelector(selectors.getDisplayFileIds);
  var fileCount = React.useMemo(function () {
  ...
  var _useState = React.useState(getGridConfig(width, fileCount, viewConfig, isMobileBreakpoint)),
    gridConfig = _useState[0],
    setGridConfig = _useState[1];
  var gridConfigRef = React.useRef(gridConfig);
  React.useEffect(function () {
  ...
  var sizers = React.useMemo(function () {
  ...
  var displayFileIdsRef = useInstanceVariable(reactRedux.useSelector(selectors.getDisplayFileIds));
  var getItemKey = React.useCallback(function (data) {
  ...
  var cellRenderer = React.useCallback(function (data) {
    var gc = gridConfigRef;
  ...
  var gridComponent = React.useMemo(function () {
...
var useStyles$3 = /*#__PURE__*/makeGlobalChonkyStyles(function () {
  return {
    gridContainer: {}
  };
});
...
var ListContainer = /*#__PURE__*/React.memo(function (props) {
  ...
  var getItemKey = React.useCallback(function (index) {
    var _displayFileIdsRef$cu;
    return (_displayFileIdsRef$cu = displayFileIdsRef.current[index]) != null ? _displayFileIdsRef$cu : "loading-file-" + index;
  }, [displayFileIdsRef]);
  var classes = useStyles$2();
  var listComponent = React.useMemo(function () {
    ...
    var rowRenderer = function rowRenderer(data) {
      ...
      return React.createElement("div", {
        ...
        fileViewMode: exports.FileViewMode.List
      }));
    };
...
var useStyles$2 = /*#__PURE__*/makeLocalChonkyStyles(function (theme) {
  return {
    listContainer: {
...
var FileList = /*#__PURE__*/React.memo(function (props) {
  var displayFileIds = reactRedux.useSelector(selectors.getDisplayFileIds);
  var viewConfig = reactRedux.useSelector(selectFileViewConfig);
  var currentFolder = reactRedux.useSelector(selectCurrentFolder);
  var _useFileDrop = useFileDrop({
      file: currentFolder
    }),
    drop = _useFileDrop.drop,
  ...
  var classes = useStyles$1(viewConfig);
  ...
  var listRenderer = React.useCallback(function (_ref) {
    ...
    } else if (viewConfig.mode === exports.FileViewMode.List) {
  ...
  return React.createElement("div", {
    ...
    icon: dndCanDrop ? exports.ChonkyIconName.dndCanDrop : exports.ChonkyIconName.dndCannotDrop
...
var useStyles$1 = /*#__PURE__*/makeGlobalChonkyStyles(function () {
  return {
    fileListWrapper: {
      height: '100%',
      maxHeight: '100%'
...
var FileContextMenu = /*#__PURE__*/React.memo(function () {
  ...
  var browserMenuShortcutString = intl.formatMessage({
    id: getI18nId(exports.I18nNamespace.FileContextMenu, 'browserMenuShortcut'),
    defaultMessage: 'Browser menu: {shortcut}'
  }, {
    shortcut: React.createElement("strong", null, "Alt + Right Click")
  });
  var contextMenuConfig = reactRedux.useSelector(selectContextMenuConfig);
  var contextMenuItems = reactRedux.useSelector(selectContextMenuItems);
  var hideContextMenu = useContextMenuDismisser();
  var contextMenuItemComponents = React.useMemo(function () {
    var components = [];
    var _loop = function _loop() {
...
var useStyles = /*#__PURE__*/makeGlobalChonkyStyles(function () {
  return {
    contextMenuList: {
      paddingBottom: important(0),
      paddingTop: important(0)
...
var FullFileBrowser = /*#__PURE__*/React.memo( /*#__PURE__*/React.forwardRef(function (props, ref) {
  var _props$folderChain;
  var onScroll = props.onScroll;
  return React.createElement(FileBrowser, _extends({
    ref: ref
  }, props), (_props$folderChain = props.folderChain) != null && _props$folderChain.length ? React.createElement(FileNavbar, null) : undefined, React.createElement(FileToolbar, null), React.createElement(FileList, {
    onScroll: onScroll
...
var useFileMapMethods = function useFileMapMethods(baseFileMap, initialFolderId) {
  var _useState = React.useState(baseFileMap),
    fileMap = _useState[0],
    setFileMap = _useState[1];
  var _useState2 = React.useState(initialFolderId),
    currentFolderId = _useState2[0],
    setCurrentFolderId = _useState2[1];
  var resetFileMap = React.useCallback(function () {
    setFileMap(baseFileMap);
    setCurrentFolderId(initialFolderId);
  }, [baseFileMap, initialFolderId]);
  var moveFiles = React.useCallback(function (files, source, destination) {
...
exports.ChonkyActions = ChonkyActions;
exports.ChonkyDndFileEntryType = ChonkyDndFileEntryType;
exports.ChonkyIconContext = ChonkyIconContext;
exports.DefaultFileActions = DefaultFileActions;
exports.FileBrowser = FileBrowser;
exports.FileContextMenu = FileContextMenu;
exports.FileHelper = FileHelper;
exports.FileList = FileList;
exports.FileNavbar = FileNavbar;
exports.FileToolbar = FileToolbar;
exports.FullFileBrowser = FullFileBrowser;
exports.OptionIds = OptionIds;
...
exports.makeGlobalChonkyStyles = makeGlobalChonkyStyles;
...
exports.selectForceEnableOpenParent = selectForceEnableOpenParent;
exports.selectHiddenFileCount = selectHiddenFileCount;
exports.selectHiddenFileIdMap = selectHiddenFileIdMap;
exports.selectHideToolbarInfo = selectHideToolbarInfo;
...
exports.usePropReduxUpdate = usePropReduxUpdate;
//# sourceMappingURL=chonky.cjs.development.js.map
